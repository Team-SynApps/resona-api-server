...
import com.synapps.resona.report.dto.response.CommentReportResponse;
...
public class CommentReportService {
    ...
    @Transactional
    public CommentReportResponse reportComment(Long reporterId, Long commentId, ReportCategory category, boolean isBlocked) {
        ...
        if (commentReportRepository.existsByReporterAndCommentId(reporter, commentId)) {
            throw ReportException.alreadyReported();
        }

        CommentReport commentReport = CommentReport.of(reporter, reported, commentId, category);
        ...
        return new CommentReportResponse(commentReport);
    }
}
