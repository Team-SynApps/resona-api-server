...
class CommentQueryRepositoryTest {
  ...
  void setUp() {
    ...
    viewer = MemberFixture.createMember("viewer@test.com", "viewer");
    writer = MemberFixture.createMember("writer@test.com", "writer");
    blockedWriter = MemberFixture.createMember("blocked@test.com", "blocked");
