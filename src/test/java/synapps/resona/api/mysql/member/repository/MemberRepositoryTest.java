...
class MemberRepositoryTest extends IntegrationTestSupport {
    ...
    void existsByEmail() {
        // given
        Member member = Member.of("test@example.com", "password123", LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now());
    ...
    void findByEmail() {
        // given
        Member member = Member.of("user@example.com", "securepassword", LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now());
        memberRepository.save(member);
    ...
    void findById() {
        // given
        Member member = Member.of("member@test.com", "password", LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now());
