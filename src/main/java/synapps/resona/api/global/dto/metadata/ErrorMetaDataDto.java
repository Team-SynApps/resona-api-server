...
public class ErrorMetaDataDto extends MetaDataDto {
  ...
  public ErrorMetaDataDto(int status, String message, String path, String apiVersion,
      String serverName, String errorCode) {
    super(status, message, path, apiVersion, serverName);
    this.errorCode = errorCode;
  }

  public static ErrorMetaDataDto createErrorMetaData(int status, String message, String path,
