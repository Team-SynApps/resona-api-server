...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<?> handleEmailException(EmailException ex, HttpServletRequest request) {
    ErrorMetaDataDto metaData = createErrorMetaData(ex.getStatus().value(), ex.getMessage(),
  ...
  private ErrorMetaDataDto createErrorMetaData(int statusCode, String message, String requestUri,
      String errorCode) {
  ...
  private ResponseEntity<?> createEmailErrorResponse(ErrorMetaDataDto metaData, HttpStatus status,
