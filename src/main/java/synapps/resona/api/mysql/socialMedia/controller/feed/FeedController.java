...
import synapps.resona.api.global.dto.metadata.CursorBasedMeta;
...
public class FeedController {
  ...
  private Meta createSuccessMetaData(String queryString, String cursor, int size,
      boolean hasNext) {
    return CursorBasedMeta.createSuccessMetaData(queryString, serverInfo.getApiVersion(),
  ...
  public ResponseEntity<?> readFeedByCursor(HttpServletRequest request,
    ...
    Meta metaData = createSuccessMetaData(request.getQueryString(), feeds.getCursor(), size,
        feeds.isHasNext());
  ...
  public ResponseEntity<?> readFeedsByMemberWithCursor(HttpServletRequest request,
    ...
    CursorResult<FeedReadResponse> result = feedService.getFeedsByCursorAndMemberId(cursor, size,
        memberId);
    Meta metaData = createSuccessMetaData(request.getQueryString(), result.getCursor(), size,
        result.isHasNext());
