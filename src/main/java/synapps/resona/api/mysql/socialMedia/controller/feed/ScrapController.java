...
public class ScrapController {
  ...
  private Meta createCursorMetaData(String queryString, String cursor, int size,
      boolean hasNext) {
  ...
  public ResponseEntity<?> readScraps(HttpServletRequest request,
    ...
    Meta metaData = createCursorMetaData(request.getQueryString(), result.getCursor(), size,
        result.isHasNext());
