...
public enum CountryCode {
  ...
  static {
    for (CountryCode countryCode : values()) {
      codeToEnumMap.put(countryCode.name(), countryCode);
      nameToEnumMap.put(countryCode.countryName.toLowerCase(), countryCode);
    }
  }
  ...
  public static CountryCode fromCode(String code) {
    return codeToEnumMap.get(code.toUpperCase());
  }
