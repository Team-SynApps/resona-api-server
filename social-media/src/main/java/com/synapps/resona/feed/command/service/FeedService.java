...
public class FeedService {
  ...
  private void publishFeedCreatedEvent(Feed feed, Member member,
    ...
    Optional<LocationInfo> locationInfo = Optional.ofNullable(locationRequest.getAddress())
        .map(address -> new FeedCreatedEvent.LocationInfo(
            locationRequest.getCoordinate(),
            address,
